...
class FulfilledOrders extends StatefulWidget {
  const FulfilledOrders({super.key});

  @override
  State<FulfilledOrders> createState() => _FulfilledOrdersState();
}

class _FulfilledOrdersState extends State<FulfilledOrders> {
  List<dynamic> orders = [];
  ...
  Future<void> fetchData() async {
    try {
      final url = "http://192.168.18.18/apiss/getFulfilledOrders.php";
